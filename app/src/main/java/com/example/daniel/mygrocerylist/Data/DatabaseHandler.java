package com.example.daniel.mygrocerylist.Data;
...
import com.example.daniel.mygrocerylist.Util.Constants;
...
public class DatabaseHandler extends SQLiteOpenHelper{
    ...
    public int getGroceriesCount(){
        ...
        String countQuesry = "SELECT * FROM " + Constants.TABLE_NAME;
        SQLiteDatabase db = this.getReadableDatabase();

        Cursor cursor = db.rawQuery(countQuesry, null);
